  ...
  <!-- /.navbar -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="javascript:;" class="brand-link" style="text-align: center">
          <span class="brand-text font-weight-light" style="font-weight: bold !important;font-size:20px;">KampusKU</span>
        </a>
        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                <a href="{{ url('dosen/dashboard') }}" class="nav-link @if(Request::segment(1) == 'Dosen') active @endif">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                    Dashboard
                  </p>
              ...
              <li class="nav-item">
                <a href="{{ url('mahasiswa/dashboard') }}" class="nav-link @if(Request::segment(1) == 'Mahasiswa') active @endif">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                    Dashboard
                  </p>
